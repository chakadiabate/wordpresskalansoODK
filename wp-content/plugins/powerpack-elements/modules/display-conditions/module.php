...
class Module extends Module_Base {
	...
	public function get_groups() {
		return [
			...
			self::WOO_GROUP => [
				'label' => __( 'WooCommerce', 'powerpack' ),
			],
		];
	}
	...
	public function add_controls( $element, $args ) {
		...
		$this->_conditions_repeater->add_control(
			...
			[
				...
				'label_block'   => true,
				'options'       => [
					'==' => __( 'Is equal to', 'powerpack' ),
					'!=' => __( 'Is not equal to', 'powerpack' ),
					'<'  => __( 'Is less than', 'powerpack' ),
					'>'  => __( 'Is greater than', 'powerpack' ),
					'<=' => __( 'Is less than equal to', 'powerpack' ),
					'>=' => __( 'Is greater than equal to', 'powerpack' ),
				],
				'condition'     => [
					'pp_condition_key' => [
						'woo_cart_items_count',
		...
		$this->_conditions_repeater->add_control(
			...
			[
				...
				'options'       => [
					...
					'<'  => __( 'Before', 'powerpack' ),
					'>'  => __( 'After', 'powerpack' ),
					'<=' => __( 'On or Before', 'powerpack' ),
					'>=' => __( 'On or After', 'powerpack' ),
				],
				'condition'     => [
